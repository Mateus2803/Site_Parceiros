...
<body>
    ...
    <section class="container-md">
        <div id="row-segmentos" class="row" style="padding: 50px;">
            <div class="col">
                <div id="txt-inicio-segmentos" style="margin: 22px 0px 0 calc((100% - 390px) * 0.5); width: 390px; height: auto;">

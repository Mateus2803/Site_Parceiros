...
<body>
    ...
    <section class="container-md">
        <div id="row-segmentos" class="row" style="padding: 50px;">
            <div class="col">
                <div id="txt-inicio-segmentos" style="margin: 154px 0px 0 calc((100% - 390px) * 0.5); width: 390px; height: auto;">
                    <p class="text-secondary" style="font-size: 17px; line-height: 1.4em; font-weight: 400; color: #2f2e2e!important;">
                        Gerencie informações e fases de cada automóvel da sua oficina.
                    </p>
                    <p class="text-secondary" style="font-size: 17px; line-height: 1.4em; font-weight: 400; color: #2f2e2e!important;">
                        Com o 360, você acelera o crescimento do seu negócio. Acompanhe todas as etapas dos serviços da sua oficina.
                    </p>
                </div>
            </div>
            <div class="col">
                <img id="img-inicio-segmentos" fetchpriority="high" sizes="488px" srcset="https://static.wixstatic.com/media/fa3eb5_4d7bb945aa0c4294b75c25f9566d6592~mv2.png/v1/fill/w_488,h_485,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/MECANICA%202.png 1x, https://static.wixstatic.com/media/fa3eb5_4d7bb945aa0c4294b75c25f9566d6592~mv2.png/v1/fill/w_976,h_970,al_c,q_90,usm_0.66_1.00_0.01,enc_avif,quality_auto/MECANICA%202.png 2x" id="img_comp-m2n81ulj" src="https://static.wixstatic.com/media/fa3eb5_4d7bb945aa0c4294b75c25f9566d6592~mv2.png/v1/fill/w_488,h_485,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/MECANICA%202.png" alt="MECANICA 2.png" class="BI8PVQ Tj01hh" width="488" style="object-fit: cover;">
            </div>
        </div>
    </section>

...
<body>
    ...
    <section class="container-md">
        <div class="row" style="padding: 50px;">
            <div class="col">
                <div style="margin: 154px 0px 0 calc((100% - 350px) * 0.5); width: 390px; height: auto;">

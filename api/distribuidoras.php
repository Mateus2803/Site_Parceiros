...
<body>
    ...
    <?php
    $distribuidoras = "color: #3d9be9;";
    include('header.php');
    ?>

    <section class="container-fluid m-0 p-0" style="position: relative;">
        <video id="comp-lxksocwa1_video" class="K8MSra" crossorigin="anonymous" loop muted autoplay="autoplay" src="https://video.wixstatic.com/video/11062b_1edc73181da84de2a85a88c62346f05f/1080p/mp4/file.mp4" style="position: absolute; top:0;height: 100%; width: 100%; object-fit: cover; object-position: center center; opacity: 1; z-index: 1;"></video>
        ...
        <div id="row-segmentos" class="row" style="padding: 50px;">
            <div class="col">
                <div id="txt-inicio-segmentos" style="margin: 62px 0px 0 calc((100% - 350px) * 0.5); width: 390px; height: auto;">
                    ...
                    <p class="text-secondary" style="font-size: 17px; line-height: 1.4em; font-weight: 400; color: #2f2e2e!important;">
                        Com o sistema 360, você ganha muito mais agilidade e praticidade na rotina da sua empresa, eliminando processos manuais que tomam seu tempo.
                    </p>
                    <p class="text-secondary" style="font-size: 17px; line-height: 1.4em; font-weight: 400; color: #2f2e2e!important;">
                        Organize seu estoque, cadastre produtos e transportadoras e emita relatórios estratégicos com dados sobre mercadorias que permanecem mais ou menos tempo no seu estoque.
                    </p>
                    <p class="text-secondary" style="font-size: 17px; line-height: 1.4em; font-weight: 400; color: #2f2e2e!important;">
                        E o melhor: tudo integrado a todas as áreas do negócio.
                    </p>
                </div>
            </div>
            <div class="col">
